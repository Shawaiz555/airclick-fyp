...
export default function UserSidebar({ isOpen, onToggle }) {
   ...
   const navItems = [
      ...
      {
         id: 'gestures-management',
         label: 'Gesture Management',
         href: '/User/gestures-management',
         icon: Hand
      },
      {
         id: 'settings',
   ...
   const getActiveTab = () => {
      ...
      if (pathname === '/User/gestures-management') return 'gestures-management';
               ...
               <nav className="relative p-0 h-full overflow-auto">
                  ...
                  <div className="p-6 flex flex-col h-full">
                     ...
                     <button
                        ...
                        className="mt-4 w-full flex items-center space-x-3 font-bold px-4 py-2 rounded-lg bg-cyan-500 hover:bg-cyan-600 transition-colors"
                     >
