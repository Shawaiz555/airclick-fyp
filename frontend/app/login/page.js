            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full bg-gray-700/50 border border-cyan-500/30 rounded-lg px-4 py-3 pr-12 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:border-transparent text-white placeholder-gray-400"
                  placeholder="••••••••"
                  required
                />
                <button
