              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-10 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                  ...
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold">Total Users</p>
                    <p className="text-2xl font-bold text-purple-300/80">{stats.total}</p>
                  </div>
                </div>

                {/* Active Users */}
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-10 border border-cyan-500/20 hover:border-green-500/40 transition-all duration-300">
                  <div className="flex items-center justify-center mb-3">
                    <div className="w-13 h-13 rounded-xl bg-gradient-to-br from-green-500 to-emerald-600 flex items-center justify-center shadow-lg shadow-green-500/20">
                      <UserCheck className="h-7 w-7 text-white" />
                    </div>
                  </div>
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold">Active Users</p>
                    <p className="text-2xl font-bold text-purple-300/80">{stats.active}</p>
                  </div>
                </div>
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-10 border border-cyan-500/20 hover:border-amber-500/40 transition-all duration-300">
                  ...
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold">Inactive Users</p>
                    <p className="text-2xl font-bold text-purple-300/80">{stats.inactive}</p>
                  </div>
                </div>
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-10 border border-cyan-500/20 hover:border-purple-500/40 transition-all duration-300">
                  ...
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold">Administrators</p>
                    <p className="text-2xl font-bold text-purple-300/80">{stats.admins}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 md:p-6 border border-purple-500/20 mb-6">
                <div className="flex flex-col lg:flex-row gap-4">
                  ...
                  <button
                    ...
                    className={`flex items-center justify-center hover:cursor-pointer gap-2 px-6 py-3 rounded-xl font-medium border transition-all duration-300 hover:scale-105 ${showFilters
                      ...
                      {currentUsers.length === 0 ? (
                        ...
                        currentUsers.map((user) => (
                          ...
                          >
                            ...
                            <td className="p-4 text-center">
                              <span className={`px-3 py-1 rounded-full text-xs font-medium ${user.status === 'ACTIVE' ? 'bg-green-500/20 text-green-300' : 'bg-amber-500/20 text-amber-300'
                                }`}>
                                {user.status}
                              </span>
                            </td>
                        ...
                        if (index > 0 && number - array[index - 1] > 1) {
                          return [
                            ...
                            <button
                              ...
                              className={`px-4 py-2 rounded-lg font-medium border transition-all duration-300 hover:scale-105 ${currentPage === number
                                ? 'bg-gradient-to-r from-cyan-500 to-blue-500 border-cyan-500/40'
                                : 'bg-gray-700/50 border-purple-500/30 hover:border-purple-500/50'
                                }`}
                            >
