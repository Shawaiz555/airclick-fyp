      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center p-4">
        <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-12 border border-cyan-500/20 shadow-2xl">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-purple-200 text-xl">Verifying reset link...</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="min-h-screen bg-gradient-to-br from-indigo-900 via-purple-900 to-pink-800 flex items-center justify-center p-4">
        <div className="w-full max-w-lg">
          <div className="text-center my-8">
            <h1 className="text-3xl lg:text-[42px] font-bold bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-red-500 mb-4">
              Invalid Reset Link
            </h1>
      ...
      <div className="w-full max-w-lg">
        ...
        <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-8 border border-cyan-500/20 shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-6 py-6">
            {/* New Password Field */}
            <div>
              <label htmlFor="newPassword" className="block text-md font-medium mb-2 text-cyan-200">
                New Password
              </label>
            ...
            <div>
              <label htmlFor="confirmPassword" className="block text-md font-medium mb-2 text-cyan-200">
                Confirm Password
              </label>
              <div className="relative">
                <input
