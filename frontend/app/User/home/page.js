...
export default function Home() {
  ...
  // Maintenance mode - stops gestures when admin enables it
  ...
  // Stop camera automatically when maintenance mode is enabled
  useEffect(() => {
    if (isMaintenanceMode && isCameraActive) {
      setIsCameraActive(false);
      setIsConnected(false);
      setHandDetected(false);
      setLandmarkDetected(false);
              ...
              <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-8 border border-cyan-500/20 hover:border-cyan-500/40 transition-all duration-300">
                  ...
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold mb-1">Camera</p>
                    <p className="text-md font-bold text-purple-300/80 mb-2">{isConnected ? 'Active' : 'Inactive'}</p>
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-8 border border-cyan-500/20 hover:border-purple-500/40 transition-all duration-300">
                  ...
                  {/* Text Content - Centered */}
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold mb-1">Hand</p>
                    <p className="text-md font-bold text-purple-300/80 mb-2">{handDetected ? 'Detected' : 'No Hand'}</p>
                    <div className="flex items-center justify-center gap-2">
                      <div className={`w-2 h-2 rounded-full ${handDetected ? 'bg-green-500 animate-pulse' : 'bg-gray-500'}`}></div>
                      <p className="text-xs text-gray-400">{handDetected ? 'Tracking' : 'Waiting'}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-8 border border-cyan-500/20 hover:border-amber-500/40 transition-all duration-300">
                  ...
                  {/* Text Content - Centered */}
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold mb-1">Gestures</p>
                    <p className="text-2xl font-bold text-purple-300/80 mb-2">{userGestures.length}</p>
                ...
                <div className="bg-gray-800/30 backdrop-blur-lg rounded-2xl p-4 py-8 border border-cyan-500/20 hover:border-emerald-500/40 transition-all duration-300">
                  ...
                  {/* Text Content - Centered */}
                  <div className='text-center'>
                    <p className="text-xl text-white font-bold mb-1">Context</p>
                    <p className="text-md font-bold text-purple-300/80 mb-2 truncate">{activeApp}</p>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                  ...
                  <div className="relative rounded-3xl overflow-hidden border-2 border-cyan-500/30 bg-gray-900/30 backdrop-blur-md shadow-2xl" style={{ height: '540px' }}>
                    ...
                    {/* Maintenance overlay — sits on top of everything */}
                    {isMaintenanceMode && (
                      <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-gray-900/80 backdrop-blur-sm">
                        ...
                        <p className="text-xl font-bold text-amber-300 mb-1">System Under Maintenance</p>
                        <p className="text-sm text-gray-400">Gesture controls are disabled. Please wait.</p>
                      </div>
                    )}
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    <button
                      onClick={isMaintenanceMode ? undefined : toggleCamera}
                      disabled={isMaintenanceMode}
                      title={isMaintenanceMode ? 'System under maintenance' : undefined}
                      className={`py-4 px-6 rounded-2xl font-bold transition-all duration-300 flex items-center justify-center gap-3 shadow-lg ${
                        isMaintenanceMode
                          ? 'bg-gray-700/60 text-gray-500 cursor-not-allowed border border-gray-600/30'
                          : isCameraActive
                            ? 'bg-gradient-to-r from-red-500 to-rose-600 hover:from-red-600 hover:to-rose-700 hover:shadow-red-500/40 transform hover:scale-[1.02] cursor-pointer'
                            : 'bg-gradient-to-r from-cyan-500 to-blue-600 hover:from-cyan-600 hover:to-blue-700 hover:shadow-cyan-500/40 transform hover:scale-[1.02] cursor-pointer'
                      }`}
                    >
                      {isCameraActive ? (
                        <>
